            ...
            if(user.id==userId) {  //进入自己的个人中心
                ...
                for (var i = 0; i < 10; i++) {
                    if (i == loc)
                        ...
                        document.getElementById('personalCenter-right' + i).style.display = "block";
                    document.getElementById('personalCenter-right').style.display = "block";
                }
            }else{   //进入别人的个人中心
...
function onloadBlackListShow(userId) {
    document.getElementById('hidden').style.display='flex';
    var json = {};
    //json.type= type;
    json.start = 0;
    ...
    $.ajax({
        type: "POST",
        url: "/user/personalCenter/my_blacklist",
        data: data,
        contentType: "application/json",
        error: function () {
            alert('加载黑名单失败 ');
        ...
        success: function (data1) {
            ...
            var temp ={};
            temp.question=data1.dataList;
            $("#each_blacklist").tmpl(temp).appendTo("#my_blacklist");
            ...
            new Page({
                ...
                getPage: function (page) {
                    //获取当前页数
                    document.getElementById('my_blacklist').innerHTML="";
                    var json = {};
                    json.type= type;
                    json.start = (page-1)*10;
                    json.num = 10;
...
function onloadFollowerShow(userId) {
    document.getElementById('hidden').style.display='flex';
    var json = {};
    //json.type= type;
    json.start = 0;
    ...
    $.ajax({
        type: "POST",
        url: "/user/personalCenter/my_follower",
        data: data,
        contentType: "application/json",
        error: function () {
            alert('加载关注人失败 ');
        ...
        success: function (data1) {
            ...
            var temp ={};
            temp.question=data1.dataList;
            $("#each_follower").tmpl(temp).appendTo("#my_follower");
            ...
            new Page({
                ...
                getPage: function (page) {
                    //获取当前页数
                    document.getElementById('my_follower').innerHTML="";
                    var json = {};
                    json.type= type;
                    json.start = (page-1)*10;
                    json.num = 10;
...
function onloadFansShow(userId) {
    document.getElementById('hidden').style.display='flex';
    var json = {};
    //json.type= type;
    json.start = 0;
    ...
    $.ajax({
        type: "POST",
        url: "/user/personalCenter/my_fans",
        data: data,
        contentType: "application/json",
        error: function () {
            alert('加载我的粉丝失败 ');
        ...
        success: function (data1) {
            ...
            var temp ={};
            temp.question=data1.dataList;
            $("#each_fan").tmpl(temp).appendTo("#my_fans");
            ...
            new Page({
                ...
                getPage: function (page) {
                    //获取当前页数
                    document.getElementById('my_fans').innerHTML="";
                    var json = {};
                    json.type= type;
                    json.start = (page-1)*10;
                    json.num = 10;
                    ...
                    $.ajax({
                        ...
                        success: function (data1) {
                            if(data1.status==999){
                                ...
                                var temp = {};
                                temp.question=data1.dataList;
                                $("#each_fans").tmpl(temp).appendTo("#my_fans");
                            }
                            document.getElementById('hidden').style.display='none';
                        }
                    })
