...
public interface UserService {
    ...
    public ResultInfo getUserBlackList(Integer userId,Integer start,Integer num);//获取某个用户的黑名单

    public ResultInfo getUserAllFollower(Integer userId,Integer start,Integer num);//获取某个用户关注者的全部信息

    public ResultInfo getUserAllFans(Integer userId,Integer start,Integer num);//获取某个用户粉丝的全部信息
