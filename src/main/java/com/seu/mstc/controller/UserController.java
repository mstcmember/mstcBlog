...
public class UserController {
    ...
    //查询某用户的黑名单
    @RequestMapping(value = "/personalCenter/my_blacklist", method = RequestMethod.POST)
    public ResultInfo personalBlackList(@RequestBody JSONObject jsonObject, HttpServletResponse response) {
        ResultInfo result = null;
        try {
            int userId = jsonObject.getInteger("userId");//被查询的用户id
            int start = jsonObject.getInteger("start");//分页的起始
            int num = jsonObject.getInteger("num");//需要查询的数量
            result = userService.getUserBlackList(userId, start, num);
        } catch (Exception e) {
            logger.error("查询某用户发布的相关信息时服务器发生异常" + e.getMessage());
            e.printStackTrace();
        }
    ...
    @RequestMapping(value = "/personalCenter/my_follower", method = RequestMethod.POST)
    public ResultInfo personalAllFollower(@RequestBody JSONObject jsonObject, HttpServletResponse response) {
        ResultInfo result = null;
        try {
            int userId = jsonObject.getInteger("userId");//被查询的用户id
            int start = jsonObject.getInteger("start");//分页的起始
            int num = jsonObject.getInteger("num");//需要查询的数量
            result = userService.getUserAllFollower(userId, start, num);
        } catch (Exception e) {
            logger.error("查询某用户发布的相关信息时服务器发生异常" + e.getMessage());
            e.printStackTrace();
        }
    ...
    //查询某用户的粉丝
    @RequestMapping(value = "/personalCenter/my_fans", method = RequestMethod.POST)
    public ResultInfo personalAllFans(@RequestBody JSONObject jsonObject, HttpServletResponse response) {
        ResultInfo result = null;
        try {
            int userId = jsonObject.getInteger("userId");//被查询的用户id
            int start = jsonObject.getInteger("start");//分页的起始
            int num = jsonObject.getInteger("num");//需要查询的数量
            result = userService.getUserAllFans(userId, start, num);
        } catch (Exception e) {
            logger.error("查询某用户发布的相关信息时服务器发生异常" + e.getMessage());
            e.printStackTrace();
        }
